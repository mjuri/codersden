...
public class WODClassService {
	...
	public WODClass cancelWODClass(String identifier, String profileIdentifier) throws ProfileNotFoundException, NotFoundException, MaxCapacityReachedException {
